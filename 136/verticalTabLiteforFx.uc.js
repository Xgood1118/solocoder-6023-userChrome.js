...
// @include        main
// @compatibility  Firefox 136 Not compatible with sidebar.revamp, sidebar.verticalTabs and browser.tabs.groups.enabled
// @author         Alice0775
// @note           not support pinned tab yet
// @version        2025/02/15 tweak css soundplaying/mute icon for Bug 1921060, 1945993
...
function verticalTabLiteforFx() {
  ...
  if (Services.prefs.getBoolPref("sidebar.verticalTabs", true)) {
    return;
  }
  if (Services.prefs.getBoolPref("browser.tabs.groups.enabled", true)) {
    return;
  }
