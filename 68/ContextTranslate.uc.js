(function () {
	...
	let translate = function () {
		...
		browserMM.addMessageListener('getSelection', function listener(message) {
			...
			if (t) {
				openWebLinkIn('http://translate.google.com/#auto/ja/' + encodeURIComponent(message.data), 'tab');
			} else {
				openWebLinkIn('http://translate.google.com/translate?u=' + encodeURIComponent(gBrowser.currentURI.spec) + '&hl=ja&ie=' + e + '&sl=auto&tl=ja', 'tab');
			};
	...
	menuitem.setAttribute('label', 'Context Translate');
	menuitem.setAttribute('tooltiptext', 'Google Translate');
